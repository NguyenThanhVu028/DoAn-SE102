...
public:
	CAnimation(int defaultTime = 100) { this->defaultTime = defaultTime; lastFrameTime = -1; currentFrame = -1; lastFlickeringTime = CGame::GetInstance()->GetTickCount(); isFlickering = false; ratio = 1; }
